    ...
    <div class="login">
        <el-form ref="formRef" :model="form" :rules="rules">
            ...
            <el-form-item prop="password">
                <el-input type="text" v-model="form.password" :placeholder="$t('login.newPassword')" show-password></el-input>
            </el-form-item>
            ...
            <el-button type="primary" @click="sendMsgHandle" style="margin-top: 20px;">{{ $t('login.submit') }}</el-button>
...
const rules = ref({
    ...
    password: [{ required: true, message: () => t('login.newPassword'), trigger: 'blur' }],
