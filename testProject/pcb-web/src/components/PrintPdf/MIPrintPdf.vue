    ...
    <!--工艺单信息、钻孔信息、开料信息、压合信息-->
        <div style="width: 100%; position: relative; page-break-before: always; box-sizing: border-box"
            ...
            <table style="border-collapse: collapse; border: none;width:100%;">
                ...
                <tr>
                    <td style="border: 1px solid black; text-align: left; width: 500pt" colspan="2"><span
                        v-if="props.allData?.pnlInfos&&props.allData?.pnlInfos[0]" style="font-size: 14px;">{{ 'PNLA：' + props.allData?.pnlInfos[0].pnlLength
                        + '*' + (props.allData?.pnlInfos[0].pnlWidth) + 'mm' + " " + props.allData?.pnlInfos[0].unitedNumber }}</span>
                    </td>
                ...
                <tr v-if="props.allData?.pnlInfos&&props.allData?.pnlInfos[1]">
                    <td style="border: 1px solid black; text-align: left; width: 500pt" colspan="2"><span
                        v-if="props.allData?.pnlInfos[1]" style="font-size: 14px;">{{ 'PNLB：' + props.allData?.pnlInfos[1].pnlLength
                        + '*' + props.allData?.pnlInfos[1].pnlWidth + 'mm' + " " + props.allData?.pnlInfos[1].unitedNumber }}</span>
                    </td>
                    <td style="border: 1px solid black; text-align: left; width: 500pt" colspan="2">
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td style="border: 1px solid black; text-align: left; width: 250pt">
                    </td>
                </tr>
                <tr v-if="props.allData?.pnlInfos&&props.allData?.pnlInfos[1]">
                    <td style="border: 1px solid black; text-align: left; width: 500pt" colspan="2">
            ...
            <table style="border-collapse: collapse; border: none;width:100%; margin-top: 5px">
                ...
                <tr>
                    ...
                    <td style="border: 1px solid black; text-align: center; width: 500pt"><span
            ...
            <div style="width: 100%;">
                ...
                <table style="border-collapse: collapse; border: none; width: 100%; font-size: 14px">
                    <tbody>
                    <tr v-if="props.allData?.pnlInfos?.length" v-for="(plItem, index2) in props.allData?.pnlInfos">
                        ...
                        <span>{{ '开料件数' + (schema.pnlCountList&&schema.pnlCountList.filter((sc:any)=>sc.pnlId==plItem.id).length>0?schema.pnlCountList.filter((sc:any)=>sc.pnlId==plItem.id)[0].pnlQuantity:'') }}</span>
                        </td>
                        <td style="width: 180pt; border: 1px solid black;">
                        <span></span>
                        </td>
            ...
            <div style="width: 100%;">
                ...
                <table style="border-collapse: collapse; border: none; width: 100%; font-size: 14px">
                    ...
                    <tr v-for="(detail, detailIndex) in props.allData?.laminatedStructureVoList">
                        <td style="width: 60pt; border: 1px solid black; text-align: center"><span>
                            {{ (detail.layerIndex?detail.layerIndex:'') }}</span>
                        </td>
                        ...
                        <td style="width: 50pt; border: 1px solid black; text-align: center"><span>
                            {{ (detail.rawMaterialType?detail.rawMaterialType:'') }}</span></td>
                        <td style="width: 50pt; border: 1px solid black; text-align: center">
                        <span>{{ (detail?.boardThickness?detail?.boardThickness:'') }}</span>
                        </td>
                        ...
                        <td style="width: 200pt; border: 1px solid black; text-align: left">
                            <span>
                                {{'材质:'+(detail.material?detail.material:'')+'；连铜:'+(detail.linkCopper?(detail.linkCopper=='1'?'是':'否'):'')+'；铜厚:'+(detail.copperThickness?detail.copperThickness:'')+'。  '+  (detail.remark?detail.remark:'') }}
                            </span>
                        </td>
                    </tr>
                    </tbody>
        ...
        <div style="width: 100%; position: relative; page-break-before: always; box-sizing: border-box"
            ...
            <table style="border-collapse: collapse; border: none;width:100%;">
                ...
                <tr>
                    ...
                    <td style="width: 80pt">
                    <img :src="props.allData?.logo" alt="logo" style="width: 60px; height: 60px" v-if="props.allData?.logo" />
                    </td>
                    <td style="text-align: center">
                    <span style="font-size: 25px;">{{ props.allData?.enterpriseName }}</span>
                    </td>
                    ...
                    <td style="width: 80pt; text-align: right">
                    <span style="font-size: 30px; font-weight: 1000">{{ props.allData?.timeSpanDays }}</span>
                    </td>
                </tr>
                </tbody>
            </table>
            <table style="border-collapse: collapse; border: none;width:100%;">
                ...
                <tr>
                    ...
                    <div>
                        ...
                        {{ props.allData?.bundlePnlQuantity }}</span>
                        <span>&nbsp;&nbsp;</span>
                        <span style="font-size: 18px;">{{ props.allData?.pnlTotal }}</span>
                    </div>
                    <div>
            ...
            <table style="border-collapse: collapse; border: none;width:100%;">
                ...
                <tr>
                    ...
                    <span style="font-size: 16px;">生产编号：</span><span style="font-size: 16px;">
                        {{ props.allData?.productionNo }}</span>
                    </td>
                    <td style="width: 175pt; text-align: right">
...
<script setup lang="ts" name="MIPrintPdf">
const cardRef = ref()
