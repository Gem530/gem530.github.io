          ...
          <el-row>
            <el-col :span="8">
              <el-form-item label="送货时间:" prop="deliveryTime">
                <el-date-picker style="width: 100%;" v-model="tabForm.deliveryTime" type="datetime"
...
<!--                <el-input v-model="tabForm.logisticsCompany" maxLength="100" />-->
        ...
        <XTable :pageShow="false" ref="tabTable" :data="tabOrderList" border :columnList="orderColumnList" keep-source
        height="100%" class="ptable-content" :loading="dialogTableLoading"
          ...
          <template #edit-shipQuantity="scope">
            <el-input-number maxLength="11" :precision="0" :controls="false"
          ...
          <template #edit-reserveQuantity="scope">
            <el-input-number maxLength="11" :precision="0" :controls="false" :max="scope.row.orderQuantity"
              :disabled="drawer.title?.includes('详情') || drawer.title?.includes('审核')"
    ...
    <el-drawer v-model="ppppdrawer.visible" size="80%"  >
...
import { listDeliveryRecord, postListSignDeliveryRecord,getPrintDeliveryRecord, getDeliveryRecord, delDeliveryRecord,getRefreshDeliveryInfoList,
