<template>
  <div class="p-2 xtable-page">
      ...
      <div class="mb-[10px]">
        <el-card shadow="hover">
          <el-form :model="queryParams" ref="queryFormRef" :inline="true" label-width="72px">
            ...
            <el-form-item label="操作人名称" prop="nickName">
              <el-input v-model="queryParams.nickName" placeholder="请输入操作人名称" clearable style="width: 240px;" @keyup.enter="handleQuery" />
            </el-form-item>
    ...
    <el-card shadow="hover" class="xtable-card">
      <template #header>
        <el-row :gutter="10" class="mb8 global-flex flex-end">
          ...
          <el-col :span="1.5">
            <el-button type="danger" plain icon="WarnTriangleFilled" @click="handleClean" >清空</el-button>
          </el-col>
          <el-col :span="1.5">
    ...
    <!-- 操作日志详细 -->
    <el-dialog title="操作日志详细" v-model="dialog.visible" width="700px">
