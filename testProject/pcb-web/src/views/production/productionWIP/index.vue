  ...
  <div class="p-2 xtable-page">
    ...
    <el-card shadow="never" class="xtable-card">
      ...
      <el-tabs type="border-card" class="xtable-tab" v-model="editableTabsValue" @tab-change="radioTableHandle()">
        ...
        <XTable toolId="productionWIP_V2"
                ref="prodTable"
                style="height: 100%;"
                height="100%"
                :pageShow="false"
...
<script setup name="ProductionWIP" lang="ts">
  ...
  import {getProductionWIP,getProductionWIPV2} from "@/api/production/production";
  ...
  const getList = async () => {
    loading.value = true;
    const res = await getProductionWIPV2(queryParams.value);
  ...
  const columnList = ref([
    ...
    { width: '110',title: '销售订单号',fixed: "left",field: 'saleOrderCode',align: 'center',filterType: 'input' },
    { width: '50',title: '返单次数', field: 'saleOrderNum',align: 'center' },
    { width: '100',title: '订单数量', field: 'orderQuantity',align: 'center' },
    { width: '100',title: '产品名称', field: 'commodityName',align: 'center',filterType: 'input' },
    { width: '30', title: '是否补料', fixed: "left", field: 'isRemediation', align: 'center'},
    { width: '100',title: '排产单号', field: 'productionCode', align: 'center',filterType: 'input' },
    { width: '110',title: '产品编号', field: 'commodityNo',align: 'center',filterType: 'input' },
    { width: '75',title: '客户PO', field: 'customerPo',align: 'center', },
    { width: '30',title: '下单人', field: 'createByName',align: 'center', },
    { width: '75',title: '客户物料编码', field: 'materialNumber',align: 'center',filterType: 'input' },
    { width: '75',title: '投料日期', field: 'productionTime',align: 'center',filterType: 'intervalDate',
    ...
    { width: '75',title: '下单日期', field: 'placeOrderTime',align: 'center', filterType: 'intervalDate',
      filterParam: { startParams: {placeholder: '请输入开始时间',type: 'datetime',  valueFormat: 'YYYY-MM-DD HH:mm:ss'},
        endParams: {placeholder: '请输入结束时间', type: 'datetime',valueFormat: 'YYYY-MM-DD HH:mm:ss'},
        }},
    { width: '75',title: '交货日期', field: 'dispatchTime',align: 'center', filterType: 'intervalDate',
      filterParam: { startParams: {placeholder: '请输入开始时间',type: 'datetime',  valueFormat: 'YYYY-MM-DD HH:mm:ss'},
        endParams: {placeholder: '请输入结束时间', type: 'datetime',valueFormat: 'YYYY-MM-DD HH:mm:ss'},
      }},
    { width: '75',title: '超期小时（H）', field: 'overdueDay',align: 'center', },
    //{ width: '75',title: '客户等级', field: 'customerLevel',align: 'center', },
    { width: '75',title: 'SET长', field: 'setLength',align: 'center', },
    { width: '75',title: 'SET宽', field: 'setWidth',align: 'center', },
    { width: '75',title: '单SET面积', field: 'singleSetArea',align: 'center', },
    { width: '75',title: '排产总量', field: 'productionSumNum',align: 'center', },
    { width: '75',title: '预扣库存', field: 'relaDeliveryQuantity',align: 'center', },
    { width: '75',title: 'SET/PNL', field: 'setQuantity',align: 'center', },
    { width: '75',title: 'PCS/PNL', field: 'pcsQuantity',align: 'center', },
    { width: '75',title: '阻焊颜色', field: 'saleSolderCs',align: 'center',filterType: 'input' },
    { width: '75',title: '成型方式', field: 'forming',align: 'center',filterType: 'input' },
    { width: '75',title: '字符颜色', field: 'characterColor',align: 'center',filterType: 'input' },
    { width: '75',title: '测试方式', field: 'testWay',align: 'center', filterType: 'input'},
    { width: '75',title: '新/返', field: 'orderType',align: 'center', filterType: 'radioButton',
      filterParam: {placeholder: '请输入新/返'}, filterData: () => [...resDictData.value.order_type], filterCustom: {label: 'dictLabel', value: 'dictValue'} },
    { width: '75',title: '状态', field: 'isPause',align: 'center', },
    { width: '75',title: '退仓量', field: 'backQuantity',align: 'center', },
    ...
    {width: '50', title: '入库差面积', field: 'inventoryDiffArea', align: 'center',},
    {width: '50', title: '入库面积', field: 'inventoryArea', align: 'center',},
    {width: '100', title: '入库数', field: 'inventoryQuantity', align: 'center',},
    {width: '100', title: '利用率', field: 'feedRate', align: 'center',},
    {width: '100', title: '报废率', field: 'scrapRate', align: 'center',filterType: 'intervalNumber'},
    {width: '50', title: '报废数（PCS）', field: 'scrapQuantity', align: 'center',},
    ...
    {width: '100', title: 'PNL宽', field: 'pnlWidth', align: 'center',},
    {width: '100', title: '单PNL面积', field: 'pnlArea', align: 'center',},
    {width: '60', title: '在线结存面积(㎡)', field: 'sumPnlArea', align: 'center'},
    {width: '70', title: '投料面积(㎡)', field: 'productionArea', align: 'center'},

    {width: '70', title: '在线结存', field: 'sumPnlQuantity', align: 'center'},
    {width: '100', title: '订单欠数', field: 'proNeedNum', align: 'center',},
    {width: '100', title: '工艺名称', field: 'craftName', align: 'center',},
    {width: '100', title: '流程个数', field: 'processNum', align: 'center',},
    {width: '100', title: 'PCS/PNL数', field: 'pcsPnlNum', align: 'center',},
    {width: '100', title: '板层', field: 'materialLayer', align: 'center',filterType: 'input',},
    {width: '100', title: '超报废数量', field: 'exceedQuantity', align: 'center',},
    {width: '100', title: '钻孔总孔数', field: 'allQuantity', align: 'center',},
    {width: '100', title: '最小钻咀', field: 'minAperture', align: 'center',},
    {width: '100', title: '阻焊面数', field: 'solderMaskNum', align: 'center',},
    {width: '100', title: '文字面数', field: 'textPrintNum', align: 'center',},
