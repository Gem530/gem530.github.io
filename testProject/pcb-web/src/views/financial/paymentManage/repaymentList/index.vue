...
<!--                    <el-input v-model="queryParams.customerName"  clearable />-->
        ...
        <el-row :gutter="10" class="mb8">
          <el-col :span="24" style="display:flex;justify-content: flex-end;">
            <el-button type="primary" style="float: right" @click="handleAdd" >新增收款单</el-button>
            <el-button v-if="checkPermi(['financial:paymentManage:importRepayData'])" @click="handleImport">导入历史数据</el-button>
          </el-col>
        </el-row>
      </template>
      <XTable
      ...
      >
        ...
        <template #default-make="scope">
          ...
          <el-button
            ...
            v-if="checkPermi(['financial:paymentManage:auditRepayment'])"
            >审核</el-button
          >
          <el-button
            link
    ...
    <el-drawer v-model="paymentTable.visible" :title="paymentTable.title" destroy-on-close  size="80%" draggable>
      ...
      <Payment @getDetail="getDetail" @saveDraft="()=>{paymentTable.visible=false;getList()}" @submitDelete="handleDelete" :loading="buttonLoading" :isUpdate="isUpdate" :readOnly="isReadOnly" :form="form" type="2" @row-click="handleRowClick" @submitPass = "submitPass" @submitReject="submitReject" @submit="submit"></Payment>
    </el-drawer>
...
const columnList = ref([
  ...
  { title: '收款单号', field: 'code', width: '160', align: 'center', filterType: undefined, filterParam: { placeholder: '请输入收款单号' } },
  ...
  { title: '关联预收款单', field: 'businessCode', width: '120', align: 'center' , filterType: 'input'},
...
/*详情*/
  const getDetail = async (id:any) =>{
    ...
    paymentTableDetail.title = "预收款单详情";
    dialogTableLoading.value = false
  }
...
const getCustomerList = async () => {
  ...
  // 上传的地址
  url: import.meta.env.VITE_APP_BASE_API + "/financial/repaymentRecord/importRepayData"
});
