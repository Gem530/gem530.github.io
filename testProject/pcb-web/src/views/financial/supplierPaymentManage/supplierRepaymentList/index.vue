...
<!--                    <el-input v-model="queryParams.customerName"  clearable />-->
      ...
      >
        ...
        <template #default-make="scope">
          ...
          <el-button
            ...
            v-if="checkPermi(['financial:supplierPaymentManage:auditRepayment'])"
            >审核</el-button
          >
          <el-button
            link
    ...
    <el-drawer v-model="paymentTable.visible" :title="paymentTable.title" destroy-on-close  size="80%" draggable>
      ...
      <Payment :isSup="true" @getDetail="getDetail" @saveDraft="()=>{paymentTable.visible=false;getList()}" @submitDelete="handleDelete" :loading="buttonLoading" :isUpdate="isUpdate" :readOnly="isReadOnly" :form="form" type="2" @row-click="handleRowClick" @submitPass = "submitPass" @submitReject="submitReject" @submit="submit"></Payment>
    </el-drawer>
