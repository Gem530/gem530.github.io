  ...
  <div class="p-2 xtable-page" >
    <transition :enter-active-class="proxy?.animate.searchAnimate.enter"
      ...
      <div class="search" v-show="showSearch">
        <el-form :model="queryParams" ref="queryFormRef"  label-width="115px">
...
<!--          </el-form-item>-->
          <el-row>
            ...
            <el-col :span="6">
              <el-form-item label="关联账单类型" prop="tax">
                <el-select
                  v-model="queryParams.accountTypeList"
                  multiple
                  placeholder="请选择关联账单类型"
                  style="width: 100%"
                  collapse-tags
            ...
            <el-col :span="6">
              <el-form-item label="销方名称" prop="tax">
                <el-input v-model="queryParams.sellerName" placeholder="请填写销方名称" clearable @keyup.enter="handleQuery" />
              </el-form-item>
            </el-col>
            <el-col :span="6">
          ...
          <el-row>
            ...
            <el-col :span="6">
              <el-form-item label="回票日期" prop="tax">
                <el-date-picker
    ...
    <el-card shadow="never" class="xtable-card">
      ...
      <XTable toolId="supplierInvoiceList" height="100%" class="xtable-content"
        ...
        <el-collapse v-model="activeName">
          <el-collapse-item title="基本信息" name="1">
            <el-row>
              ...
              <el-col :span="8">
                <el-form-item label="回票日期" prop="invoiceTime">
<!--                  <el-input v-model="form.invoiceTime" placeholder="回票日期" />-->
          ...
          <el-collapse-item title="凭证信息" name="2">
            ...
            <el-form ref="ossFormRef" :model="fileForm" :rules="ossRules" label-width="80px">
              ...
              >
                <div>
                  <el-button  type="primary"  >上传附件</el-button>    格式要求pdf/jpg/png,每个文件大小在20MB以内
                </div>
              </XUpload>
            </el-form>
...
<script setup name="SupplierInvoice" lang="ts">
import {
  listInvoice,
  getInvoice,
  delInvoice,
...
const drillerAbradeSearchChange = (param : any) => {
  ...
  drillerAbradeQueryParams.value.type = '2'
  viewRelevancyMsg();
}
...
const customerColumnList = ref([
  ...
  { title: '回票日期', field: 'invoiceTime', width: '130', align: 'center' },
...
const refreshWaitConfirmTableData = async () => {
  ...
  loading.value = true;
  queryParams.value.invoiceType = '1';
...
const data = reactive({
  ...
  rules: {
    ...
    invoiceTime: [
      { required: true, message: "回票日期不能为空", trigger: "blur" }
    ],
    amount: [
...
const resetQuery = () => {
  ...
  queryParams.value.sellerName = undefined;
...
const importTemplate = () => {
  proxy?.download("financial/invoice/importTemplate", {}, `供应商发票导入模版_${new Date().getTime()}.xlsx`);
};
