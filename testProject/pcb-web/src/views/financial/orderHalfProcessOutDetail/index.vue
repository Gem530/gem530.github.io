<template>
  <div class="p-2 xtable-page">
    ...
    <accountTable ref="accountTableRef" :tableColumnList="columnList" :tableColumnList2="columnList2"
    toolId1="halfAccountToolId1" toolId2="halfAccountToolId12" toolId3="halfAccountToolId13"
     :writeOffType="writeOffType" :type="accountOrderType"  exportName="外协半制程对账单"
    ...
    <el-drawer v-model="drawerBorrow.visible" :title="drawerBorrow.title" size="90%" draggable destroy-on-close
      ...
      <accountForm ref="accountFormRef" v-if="drawerBorrow.visible" :showCraftSelect="true" :row="formInfo" @handleSearch="handleInOrOutQuery"
        :type="formType" :isEdit="isEdit" />

      <RawAccountTab ref="rawAccountTabRef" :allData="allData"
...
const tabColumnList = ref([
  ...
  { title: '收货类型', width: '120', field: 'typeName', align: 'center' },
  { title: '加工要求', width: '120', field: 'requirement', align: 'center' },
  { title: '收货数', width: '120',fixed: 'right', field: 'inOutQuantity', align: 'center' },
