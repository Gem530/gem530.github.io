<template>
  <div class="p-2 xtable-page">
    ...
    <accountTable ref="accountTableRef" :tableColumnList="columnList" :tableColumnList2="columnList2" :type="TypeEnum.BORROW_OUT" :autoType="true"
      :writeOffTitleColumnList="writeOffTitleColumnList" :payRecordColumnList="payRecordColumnList"
      :repayRecordColumnList="repayRecordColumnList" :titleLabel="titleLabel" @handle="handle"
      toolId1="materialBorrowAccountOutToolId1" toolId2="materialBorrowAccountOutToolId2" toolId3="materialBorrowAccountOutToolId3"
      exportName="借料借出对账单" :writeOffIsSupplier="true" />
    <el-drawer v-model="drawerBorrow.visible" :title="drawerBorrow.title" size="90%" draggable destroy-on-close
      ...
      <el-card shadow="never" class="ptable-card">
        ...
        <RawAccountTab tabToolId1="borrowOutToolId1" tabToolId2="borrowOutToolId2" ref="rawAccountTabRef" :allData="allData" :tabColumnList="tabColumnList" :footLabel="footLabel"
          :editOtherList="tabOtherList" :tabName1="'借料借出'" :tabName2="'借出还回'" :tabName3="true"
...
<script setup name="MaterialBorrowOut" lang="ts">
...
const tabColumnList = ref([
  ...
  { width: '90', title: '借出日期', field: 'createTime', align: 'center' },
...
const getAddListRecord = async () => {
  ...
  //借出、 借出还回
  rQueryParams.value.type = rawInOutTypeEnum.MATERIAL_BORROW;
  backQueryParams.value.type = rawInOutTypeEnum.BORROW_RETURN;
...
const doSave = async (resForm: any) => {
  ...
  //类型
  addForm.type = TypeEnum.BORROW_OUT;
  //addForm.isTax = '1';
