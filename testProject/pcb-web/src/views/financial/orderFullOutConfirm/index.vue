<template>
  <div class="p-2 xtable-page">
    <SupConfirmTab
      ...
      toolId1="supFullaitConfirmAccount"
      toolId2="supFullConfirmAccount"
      toolId3="supFullWaitOtherConfirmAccount"
      :loading="loading"
      :total="total"
...
const searchChange = async (params: any) => {
  loading.value = true;
  params.type = TypeEnum.ALL_PROCESSING_OUTSOURCING;
...
const exportExcel = async (queryParams:any,toolId :any) => {
        proxy?.download('financial/accountOrder/confirmListExport', {
          ...queryParams, tableName: toolId,type: TypeEnum.ALL_PROCESSING_OUTSOURCING
        }, `订单外协对账确认_${new Date().getTime()}.xlsx`);
      }
/**
 * 查询按采购订单列表
 * */
