  ...
  <div class="p-2">
    <transition :enter-active-class="proxy?.animate.searchAnimate.enter"
      ...
      <div class="search" v-show="showSearch">
        <el-form :model="queryParams" ref="queryFormRef" :inline="true" label-width="68px" @submit.native.prevent>
    ...
    <el-card shadow="never">
      ...
      <el-table v-loading="loading" :data="craftList"  @selection-change="handleSelectionChange" ref="multipleTableRef">
        <el-table-column type="selection" width="55" align="center"/>
        <el-table-column label="工艺名称" width="150" align="center" prop="craftName" show-overflow-tooltip/>
        <el-table-column label="工艺参数" :show-overflow-tooltip="true" width="500" align="center" prop="craftParameterConfigs">
        ...
        <el-table-column label="工艺负责角色" align="center" prop="craftRoleNames"/>
        ...
        <el-table-column label="设备" align="center" prop="createTime" width="200">
          <template #default="scope">
            <div style="text-align:left;">
        ...
        <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
          <template #default="scope">
              <el-button link type="primary" @click="handleUpdate(scope.row)"
                         >修改</el-button>
              <!-- <el-button link type="primary"  @click="handleAuthEquipment(scope.row)"
                         >配置设备</el-button> -->
          </template>
        </el-table-column>
      </el-table>
    ...
    <!-- 添加或修改工艺对话框 -->
    <el-drawer :title="dialog.title" v-model="dialog.visible" size="58%" destroy-on-close @close="reset()">
      <el-form ref="craftFormRef" :model="form" :rules="rules" label-width="80px" label-position="right">
        ...
        <div v-for="(item, index) in form.craftParameterConfigs" :key="index" style="display: flex">
          <el-row>
            ...
            <el-col :span="3">
              <div class="ml20">
                <el-checkbox style="width: 80px" v-model="item.isDifferentiatePnl" false-label="1" true-label="0" label="公共参数"
                             size="large"/>
              </div>
            </el-col>
            ...
            <el-col :span="1" v-if=" index !== 0">
              <div class="mb-2 flex items-center text-sm">
                <p @click="configsDelete(index)" @change="paramerDelFlag(item)">
                  <el-icon>
                    <Minus/>
                  </el-icon>
                </p>
...
<script setup name="Craft" lang="ts">
   ...
   * 查询工艺配置列表
   */
  let craftParamers: CraftParameterConfigVO[] = [];
  const getCraftParameterLists = async () => {
    const res = await craftParameterList();
    console.log(res);
    craftParamers = res.data;
    craftParamers.forEach(item => {
      item.id = String(item.id);
    });
    console.log(craftParamers);
  };
