<template>
  <div class="p-2 xtable-page">
    ...
    <el-card shadow="hover" class="xtable-card">
      ...
      <el-table v-loading="loading" :data="tableList" @selection-change="handleSelectionChange" height="100%">
    ...
    <!-- 预览界面 -->
    <el-dialog :title="dialog.title" v-model="dialog.visible" width="80%" top="5vh"  class="scrollbar">
