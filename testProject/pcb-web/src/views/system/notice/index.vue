<template>
  <div class="p-2 eltable-page">
    ...
    <el-card shadow="hover" class="eltable-card">
      ...
      <el-table v-loading="loading" :data="noticeList" @selection-change="handleSelectionChange" height="100%">
    ...
    <!-- 添加或修改公告对话框 -->
    <el-dialog :title="dialog.title" v-model="dialog.visible" width="780px" >
