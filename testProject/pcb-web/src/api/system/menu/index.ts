...
// 查询菜单列表-xcx
export const xcxListMenu = (query?: MenuQuery): AxiosPromise<MenuVO[]> => {
  return request({
    url: '/system/menu/xcxList',
    method: 'get',
    params: query
  });
};
...
// 查询菜单下拉树结构-小程序
export const treeselectXcx = (): AxiosPromise<MenuTreeOption[]> => {
  return request({
    url: '/system/menu/treeselectXcx',
    method: 'get'
  });
};
